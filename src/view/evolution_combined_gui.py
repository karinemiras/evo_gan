...
class Ui_breeding_pictures(object):
    def setupUi(self, breeding_pictures):
        ...
        self.parent_arrows.setGeometry(QRect(397, 81, 486, 421))
        ...
        self.loading_animation.setGeometry(QRect(580, 325, 100, 100))
        ...
        self.child_label = QLabel(self.centralwidget)
        self.child_label.setObjectName(u"child_label")
        self.child_label.setGeometry(QRect(460, 670, 361, 41))
        self.child_label.setFont(font1)
        self.child_label.setStyleSheet(u"color : white;")
    ...
    def retranslateUi(self, breeding_pictures):
        ...
        self.child_label.setText(QCoreApplication.translate("breeding_pictures", u"Child", None))
    # retranslateUi
