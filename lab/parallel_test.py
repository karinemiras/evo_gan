...
class PushBut1(QtWidgets.QPushButton):
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("margin: 1px; padding: 7px;background - color: rgba(1, 255, 255, 100);" 
                           "color: rgba(0, 190, 255, 255);border - style: solid;border - radius: 3px;"
                           "border - width: 0.5px; border - color: rgba(127, 127, 255, 255);")

    def enterEvent(self, event):
        if self.isEnabled() is True:
            self.setStyleSheet("margin: 1px; padding: 7px; background - color: rgba(1, 255, 255, 100); "
                               "color: rgba(0, 230, 255, 255); border - style: solid; border - radius: 3px;"
                                "border - width: 0.5px;border - color: rgba(0, 230, 255, 255);")
...
class QthreadApp(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.linef.setStyleSheet("margin: 1px; padding: 7px; background - color: rgba(1, 255, 255, 100); "
                               "color: rgba(0, 190, 255, 255); border - style: solid; border - radius: 3px;"
                                "border - width: 0.5px;border - color: rgba(0, 140, 255, 255);")
        self.textf = QtWidgets.QTextEdit(self)
        self.textf.setPlaceholderText("Results...")
        self.textf.setStyleSheet("margin: 1px; padding: 7px; background - color: rgba(1, 255, 255, 100); "
                               "color: rgba(0, 190, 255, 255); border - style: solid; border - radius: 3px;"
                                "border - width: 0.5px;border - color: rgba(0, 140, 255, 255);")
